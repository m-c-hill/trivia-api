...
The Trivyah project is a simple trivia game where users can test their knowledge by answering questions for a range of topics including Science, Geography and Sports.

The project involved designing, writing and implementing the backend Flask API and its accompanying test suite to provide data to be consumed by the provided React frontend.
...
- Display questions, including the question category, difficulty rating and answer
- Delete questions
